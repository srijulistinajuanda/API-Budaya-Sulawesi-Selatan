          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <div class="form-outline mb-4">
                <input type="text" id="loginName" name="uname" class="form-control form-control-lg" />
              ...
              <div class="text-center">
                ...
                <p>Not a member? <a style="text-decoration:none" href="register.php">Register</a></p>
              </div>
              </form>
            </div>
          </div>
