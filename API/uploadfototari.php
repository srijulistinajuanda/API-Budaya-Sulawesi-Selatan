<?php
	...
	if($method== 'POST'){
		...
		if(isset($_POST['nama_tari']) AND isset($_POST['kota_asal']) AND isset($_POST['deskripsi'])){
			...
			//buat query
			$sql = "INSERT INTO tari(nama_tari, kota_asal, foto, deskripsi) VALUES ('$nama_tari', '$kota_asal', '$nama_foto','$deskripsi')";
			//eksekusi query
			$conn->query($sql);
